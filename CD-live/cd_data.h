/*
 * File : cd_data.h  Date: 2017_06_14
 * ==============================
 * Author : lcg
 * Target :
 *    cd_data head file define the data struct for program and 
 *  the method to do these works
 */
...
/* The tracks table , one entry per tract */
